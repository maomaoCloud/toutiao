...
Page({
  ...
  onLoad: function (options) {
    ...
    switch (index) {
      case 0: currentData = myOrder.all; break;
      case 1: currentData = myOrder.notStart; break;
      case 2: currentData = myOrder.underWay; break;
      case 3: currentData = myOrder.end; break;
    }
