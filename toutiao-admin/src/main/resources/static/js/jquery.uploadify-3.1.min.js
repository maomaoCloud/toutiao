...
(function(c) {
    var b = {init:function(d, e) {
        return this.each(function() {
            ...
            if (h) {
                ...
                i.queueData = {files:{},filesSelected:0,filesQueued:0,filesReplaced:0,filesCancelled:0,filesErrored:0,uploadsSuccessful:0,uploadsErrored:0,averageSpeed:0,queueLength:0,queueSize:0,uploadSize:0,queueBytesUploaded:0,uploadQueue:[],errorMsg:""};
                i.original = m;
                i.wrapper = l;
                i.button = f;
                i.queue = k;
            ...
            if (e[0]) {
                if (e[0] == "*") {
                    ...
                    for (var m = 0; m < e.length; m++) {
                        ...
                        if (j.onCancel) j.onCancel.call(this, i.queueData.files[d]);
                    }
                }
            } else {
    ...
    var a = {onDialogOpen:function() {
        ...
        if (c.inArray("onSelect", h.overrideEvents) < 0) {
            c("#" + h.queueID).append('<div id="' + g.id + '" class="uploadify-queue-item">					<div class="cancel">								</div>					<span class="fileName">' + j + " (" + i + ')</span><span class="data"></span>					<div class="uploadify-progress">						<div class="uploadify-progress-bar"><!--Progress Bar--></div>					</div>				</div>');
        }
        ...
        if (c.inArray("onSelectError", e.overrideEvents) < 0) {
            switch (g) {
                ...
                case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
                    this.queueData.errorMsg += '\n上传文件大小 "' + d.name + '" 超过 (' + e.fileSizeLimit + ").";
                    break;
                case SWFUpload.QUEUE_ERROR.ZERO_BYTE_FILE:
                    this.queueData.errorMsg += '\nThe file "' + d.name + '" is empty.';
                    break;
                case SWFUpload.QUEUE_ERROR.INVALID_FILETYPE:
                    this.queueData.errorMsg += '\n 请选择正确的文件类型： ' + e.fileTypeDesc + ".";
                    break;
            }
        }
